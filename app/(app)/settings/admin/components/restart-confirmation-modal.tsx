      ...
      <ModalContent>
        ...
        <ModalBody>
          ...
          <div className="bg-warning-50 dark:bg-warning-900/20 border-warning-200 dark:border-warning-800 mt-2 rounded-lg border p-4">
            <p className="text-warning-700 dark:text-warning-300 text-sm font-medium">Important:</p>
            <ul className="text-warning-600 dark:text-warning-400 mt-2 list-inside list-disc space-y-1 text-sm">
